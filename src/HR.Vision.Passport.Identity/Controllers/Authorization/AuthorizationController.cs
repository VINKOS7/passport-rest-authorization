...
namespace E.Shop.Passport.Identity.Controllers.Authorization;
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            case ConsentTypes.Explicit when authorizations.Any() && !request.HasPrompt(Prompts.Consent):
                ...
                var _listResourcesAsync = await _scopeManager.ListResourcesAsync(identity.GetScopes()).ToListAsync();

                identity.SetResources(_listResourcesAsync.ToImmutableArray());
            ...
            default:
                ...
                _listResourcesAsync = await _scopeManager.ListResourcesAsync(identity.GetScopes()).ToListAsync();

                identity.SetResources(_listResourcesAsync);
